      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="flex justify-center">
          <motion.div
            ...
            className="bg-white p-6 rounded-lg shadow-md border border-gray-100 hover:shadow-lg transition-shadow text-center max-w-md w-full h-[400px] flex flex-col justify-between"
          >
